                ...
                child: LayoutBuilder(builder:
                  ...
                  return Stack(children: [
                    TransformHelper.translateAndScale(
                        translateX: constraints.maxWidth * 0.8620557947460462,
                        translateY: constraints.maxHeight * 0.16194338609353626,
                        translateZ: 0,
                        scaleX: scaleX,
                        scaleY: scaleY,
                        scaleZ: 1,
      ...
      child: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              child: LayoutBuilder(
                  builder: (BuildContext context, BoxConstraints constraints) {
                final double width = constraints.maxWidth * 0.16758241758241757;

                final double height =
                    constraints.maxHeight * 0.34328358208955223;

                return Stack(children: [
                  TransformHelper.translate(
                      x: constraints.maxWidth * 0.42296017657269486,
      ...
      child: Stack(
          ...
          children: [
            Positioned(
              ...
              child: GeneratedGroup6798Widget2(),
            ),
            Positioned(
              left: 0.0,
              top: 0.0,
...
class GeneratedGroup6798Widget2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      width: 364.0,
...
class GeneratedGroup6803Widget1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      width: 364.0,
      ...
      child: Stack(
          ...
          children: [
            Positioned(
              ...
              width: 364.0,
              height: 0.00003182189175277017,
              child: GeneratedGroup6803Widget1(),
            ),
            Positioned(
              left: 0.0,
              top: 0.0,
      ...
      child: Stack(
          ...
          children: [
            Positioned(
              ...
              height: 23.0,
              child: TransformHelper.translate(
                  x: 0.00, y: 4.00, z: 0, child: GeneratedTimeWidget2()),
            )
          ]),
    );
  }
