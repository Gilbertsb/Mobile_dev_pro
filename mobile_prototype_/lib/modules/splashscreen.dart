        ...
        child: Stack(
            ...
            children: [
              ...
              Positioned(
                ...
                width: 364.0,
                height: 67.0,
                child: GeneratedStart_buttonWidget(),
              ),
              Positioned(
                left: -115.052734375,
                top: -64.0,
                ...
                width: 643.0,
                height: 601.0,
                child: GeneratedWazobia_black_logoWidget(),
              )
            ]),
      ),
    ));
...
class GeneratedStart_buttonWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class GeneratedWazobia_black_logoWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      width: 643.0,
